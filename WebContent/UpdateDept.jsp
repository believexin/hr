...
<body>	
	<div class="container">
		...
		<h2 class="page-header" >修改新部门</h2>
		<form id="form1" class="form-horizontal"  method="post" action="UpdateDeptServlet">
			<div class="form-group">
				<label for="" class="col-sm-2">部门名称</label>
				<div class="col-sm-10">
					<input type="text" id="deptName" name="deptName" value="${dept.deptName}" placeholder="请输入部门名称" class="form-control"/>
				</div>					
			</div>	
			<div class="form-group">
				<label for="" class="col-sm-2">部门地址</label>
				<div class="col-sm-10">
					<input type="text" id="deptLoc" name="deptLoc" value="${dept.deptLoc}" placeholder="请输入部门地址" class="form-control"/>
				</div>					
			</div>
			<div class="form-group">					
